...
export function tenantOnboardingEmail({ siteOrigin, tenant, adminUrl, adminPassword, multiTenantNote }) {
  ...
  const text = [
    ...
    ``,
    `Getting started:`,
    `- Log in with the password above — you'll be asked to accept the Terms of Service and set your own password before continuing.`,
  ...
  const bodyHtml = `
    ...
    <ol style="margin:0 0 20px;padding-left:1.2rem;font-size:0.9rem;color:#3f3f46;line-height:1.6;">
      <li>Log in with the password above — you'll be asked to accept the Terms of Service and set your own password before continuing.</li>
