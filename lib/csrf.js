...
import { SESSION_SECRET, TRUST_PROXY } from "../config.js";
...
const secureCookie = TRUST_PROXY;
...
const CSRF_EXEMPT_SUFFIXES = ["/contact", "/suggest", "/request-repo", "/report-correction", "/analytics/event"];
